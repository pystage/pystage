# looks3 (pyStage, converted from Scratch 3)
...
def when_program_starts_1(self):
    ...
    self.wait(1.0)
    self.switch_backdrop_to("next_backdrop")
    self.wait(1.0)
    self.switch_backdrop_to("previous backdrop")
    self.wait(1.0)
    self.switch_backdrop_to("random backdrop")
    self.wait(1.0)
    self.next_backdrop()
